...
def search_prs_india(query: str, max_results: int = 5) -> List[Dict]:
    return scrape_prs_india(query, max_results)


def scrape_prs_india(query: str, max_results: int = 5) -> List[Dict]:
    try:
        search_query = f"site:prsindia.org {query}"
